...
public class Family_history extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    default:
                        ...
                        return Family_history.super.onOptionsItemSelected(item);
                }
            }
        });

        Dialog dialog1;
        dialog1 = new Dialog(Family_history.this);
        dialog1.setContentView(R.layout.popup_family);
